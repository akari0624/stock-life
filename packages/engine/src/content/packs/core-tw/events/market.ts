...
export const marketEvents = [
  {
    ...
    choices: [
      { id: 'safe', label: '停損出場', odds: '+30', mag: 1, good: '你撐過了帳面波動，之後市場回穩。', bad: '你受不了心理壓力，認賠出場。' },
      { id: 'normal', label: '再觀察看看', odds: '0', mag: 2, good: '你撐過了帳面波動，之後市場回穩。', bad: '你受不了心理壓力，認賠出場。' },
      { id: 'bold', label: '逢低加碼', odds: '-25', mag: 3, good: '你撐過了帳面波動，之後市場回穩。', bad: '你受不了心理壓力，認賠出場。' },
    ],
    good: {
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '笑一笑就好', odds: '+35', mag: 1, good: '這次真的漲了。你開始相信自己有門路。', bad: '你進場那天就是最高點。他後來換了部門。' },
      { id: 'normal', label: '買一點點', odds: '-5', mag: 2, good: '這次真的漲了。你開始相信自己有門路。', bad: '你進場那天就是最高點。他後來換了部門。' },
      { id: 'bold', label: '照他說的押', odds: '-30', mag: 4, good: '這次真的漲了。你開始相信自己有門路。', bad: '你進場那天就是最高點。他後來換了部門。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '看標題就好', odds: '+25', mag: 1, good: '你在附註裡看到一句話，那句話後來救了你一次。', bad: '你讀了兩百頁，什麼也沒看出來，只是很累。' },
      { id: 'normal', label: '翻一翻財報', odds: '0', mag: 2, good: '你在附註裡看到一句話，那句話後來救了你一次。', bad: '你讀了兩百頁，什麼也沒看出來，只是很累。' },
      { id: 'bold', label: '把附註全部讀完', odds: '-20', mag: 3, good: '你在附註裡看到一句話，那句話後來救了你一次。', bad: '你讀了兩百頁，什麼也沒看出來，只是很累。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '現金為王', odds: '+30', mag: 1, good: '所有人都在賣的時候你在買。三年後你才知道那是什麼意思。', bad: '你以為那是底。底下面還有底。' },
      { id: 'normal', label: '分批進場', odds: '+5', mag: 2, good: '所有人都在賣的時候你在買。三年後你才知道那是什麼意思。', bad: '你以為那是底。底下面還有底。' },
      { id: 'bold', label: '別人恐懼我貪婪', odds: '-15', mag: 4, good: '所有人都在賣的時候你在買。三年後你才知道那是什麼意思。', bad: '你以為那是底。底下面還有底。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '這種價格我不追', odds: '+30', mag: 1, good: '狂熱又多撐了一年，你在裡面。', bad: '你買在最後一根長紅棒上。' },
      { id: 'normal', label: '小買一些跟上', odds: '-5', mag: 2, good: '狂熱又多撐了一年，你在裡面。', bad: '你買在最後一根長紅棒上。' },
      { id: 'bold', label: '全部買進去', odds: '-30', mag: 4, good: '狂熱又多撐了一年，你在裡面。', bad: '你買在最後一根長紅棒上。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '不碰融資', odds: '+35', mag: 1, good: '槓桿放大了那一年的獲利，你覺得自己終於學會了。', bad: '維持率的簡訊在早上九點二十分傳來。' },
      { id: 'normal', label: '開個戶備著', odds: '0', mag: 2, good: '槓桿放大了那一年的獲利，你覺得自己終於學會了。', bad: '維持率的簡訊在早上九點二十分傳來。' },
      { id: 'bold', label: '融資買滿', odds: '-35', mag: 4, good: '槓桿放大了那一年的獲利，你覺得自己終於學會了。', bad: '維持率的簡訊在早上九點二十分傳來。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '領息就好', odds: '+30', mag: 2, good: '一年一次的入帳不多，但它從來沒有缺席過。', bad: '填不了息，你才發現那筆錢本來就是你的。' },
      { id: 'normal', label: '股息再投入', odds: '+10', mag: 2, good: '一年一次的入帳不多，但它從來沒有缺席過。', bad: '填不了息，你才發現那筆錢本來就是你的。' },
      { id: 'bold', label: '借錢買高股息', odds: '-30', mag: 3, good: '一年一次的入帳不多，但它從來沒有缺席過。', bad: '填不了息，你才發現那筆錢本來就是你的。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '說自己也沒錢', odds: '+30', mag: 1, good: '他還了。而且從此把你當自己人。', bad: '錢沒了，朋友也沒了。你不確定哪個比較難受。' },
      { id: 'normal', label: '借一小筆', odds: '-5', mag: 2, good: '他還了。而且從此把你當自己人。', bad: '錢沒了，朋友也沒了。你不確定哪個比較難受。' },
      { id: 'bold', label: '他要多少給多少', odds: '-30', mag: 3, good: '他還了。而且從此把你當自己人。', bad: '錢沒了，朋友也沒了。你不確定哪個比較難受。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '不去', odds: '+30', mag: 1, good: '講的東西不新，但有一句話你記了很久。', bad: '課程費用比你那年賺到的還多，講師後來不見了。' },
      { id: 'normal', label: '去聽免費場', odds: '0', mag: 2, good: '講的東西不新，但有一句話你記了很久。', bad: '課程費用比你那年賺到的還多，講師後來不見了。' },
      { id: 'bold', label: '報名進階課程', odds: '-25', mag: 3, good: '講的東西不新，但有一句話你記了很久。', bad: '課程費用比你那年賺到的還多，講師後來不見了。' },
    ],
    good: {
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '一整年不看盤', odds: '+35', mag: 2, good: '你什麼都沒做，帳戶自己長大了一點。', bad: '手續費、稅、還有那些「早知道」，加起來剛好是你的獲利。' },
      { id: 'normal', label: '每月看一次', odds: '+5', mag: 2, good: '你什麼都沒做，帳戶自己長大了一點。', bad: '手續費、稅、還有那些「早知道」，加起來剛好是你的獲利。' },
      { id: 'bold', label: '每天都在調整', odds: '-30', mag: 3, good: '你什麼都沒做，帳戶自己長大了一點。', bad: '手續費、稅、還有那些「早知道」，加起來剛好是你的獲利。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '當作沒聽到', odds: '+35', mag: 1, good: '公告出來那天，你已經在裡面很久了。', bad: '消息是真的，時間點是假的。錢卡在裡面兩年。' },
      { id: 'normal', label: '查證再說', odds: '+5', mag: 2, good: '公告出來那天，你已經在裡面很久了。', bad: '消息是真的，時間點是假的。錢卡在裡面兩年。' },
      { id: 'bold', label: '趁還沒公告先買', odds: '-30', mag: 4, good: '公告出來那天，你已經在裡面很久了。', bad: '消息是真的，時間點是假的。錢卡在裡面兩年。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '不去想它', odds: '+25', mag: 1, good: '你放下了。錯過本來就是這場遊戲的一部分。', bad: '你在它漲了五倍之後買進，然後它腰斬。' },
      { id: 'normal', label: '看看現在多少', odds: '-5', mag: 2, good: '你放下了。錯過本來就是這場遊戲的一部分。', bad: '你在它漲了五倍之後買進，然後它腰斬。' },
      { id: 'bold', label: '現在追進去', odds: '-30', mag: 3, good: '你放下了。錯過本來就是這場遊戲的一部分。', bad: '你在它漲了五倍之後買進，然後它腰斬。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '維持現在的存法', odds: '+25', mag: 1, good: '你把存錢變成一件不用想的事。', bad: '省了三個月，第四個月一次補回來。' },
      { id: 'normal', label: '每個月多存一點', odds: '0', mag: 2, good: '你把存錢變成一件不用想的事。', bad: '省了三個月，第四個月一次補回來。' },
      { id: 'bold', label: '極限省下一半薪水', odds: '-25', mag: 3, good: '你把存錢變成一件不用想的事。', bad: '省了三個月，第四個月一次補回來。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '看不懂就不碰', odds: '+30', mag: 1, good: '你在別人還在笑的時候就進去了。', bad: '交易所在某個週末就不見了，客服也是。' },
      { id: 'normal', label: '買一點當學費', odds: '-10', mag: 2, good: '你在別人還在笑的時候就進去了。', bad: '交易所在某個週末就不見了，客服也是。' },
      { id: 'bold', label: '整筆換過去', odds: '-35', mag: 4, good: '你在別人還在笑的時候就進去了。', bad: '交易所在某個週末就不見了，客服也是。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '全部換現金', odds: '+20', mag: 2, good: '你做的決定，後來的自己感謝了很多年。', bad: '你賣在最低點附近，然後看著它漲回去。' },
      { id: 'normal', label: '減碼一半', odds: '+5', mag: 2, good: '你做的決定，後來的自己感謝了很多年。', bad: '你賣在最低點附近，然後看著它漲回去。' },
      { id: 'bold', label: '一股都不賣', odds: '-10', mag: 3, good: '你做的決定，後來的自己感謝了很多年。', bad: '你賣在最低點附近，然後看著它漲回去。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '叫他去買定存', odds: '+30', mag: 1, good: '他照做了，而且沒有問你明牌。', bad: '賠錢的是他，怪罪的對象是你。' },
      { id: 'normal', label: '講一些原則', odds: '+5', mag: 2, good: '他照做了，而且沒有問你明牌。', bad: '賠錢的是他，怪罪的對象是你。' },
      { id: 'bold', label: '幫他操作', odds: '-30', mag: 3, good: '他照做了，而且沒有問你明牌。', bad: '賠錢的是他，怪罪的對象是你。' },
    ],
    good: {
      effects: [
        { type: 'stat.add', key: 'network', value: 4 },
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '第一時間出清', odds: '+25', mag: 2, good: '公司撐過來了，你的持股也是。', bad: '停牌那天你才知道，財報的字是可以那樣寫的。' },
      { id: 'normal', label: '等等看說明會', odds: '-5', mag: 2, good: '公司撐過來了，你的持股也是。', bad: '停牌那天你才知道，財報的字是可以那樣寫的。' },
      { id: 'bold', label: '相信經營層', odds: '-30', mag: 3, good: '公司撐過來了，你的持股也是。', bad: '停牌那天你才知道，財報的字是可以那樣寫的。' },
    ],
    good: {
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '分散再分散', odds: '+30', mag: 2, good: '你花了二十年才敢這樣做，而它值得。', bad: '你懂的那一檔，這一次真的錯了。' },
      { id: 'normal', label: '集中在懂的幾檔', odds: '0', mag: 2, good: '你花了二十年才敢這樣做，而它值得。', bad: '你懂的那一檔，這一次真的錯了。' },
      { id: 'bold', label: '押在最懂的那一檔', odds: '-25', mag: 4, good: '你花了二十年才敢這樣做，而它值得。', bad: '你懂的那一檔，這一次真的錯了。' },
    ],
    good: {
      effects: [
