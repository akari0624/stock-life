...
export const moneyEvents = [
  {
    ...
    choices: [
      { id: 'safe', label: '繼續租', odds: '+25', mag: 1, good: '簽約那天你在空屋裡站了很久。之後那間房漲了。', bad: '頭期款掏空了你，房貸接著掏空接下來的二十年。' },
      { id: 'normal', label: '買個小的', odds: '0', mag: 2, good: '簽約那天你在空屋裡站了很久。之後那間房漲了。', bad: '頭期款掏空了你，房貸接著掏空接下來的二十年。' },
      { id: 'bold', label: '一次到位買大的', odds: '-25', mag: 3, good: '簽約那天你在空屋裡站了很久。之後那間房漲了。', bad: '頭期款掏空了你，房貸接著掏空接下來的二十年。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '搭捷運就好', odds: '+30', mag: 2, good: '你把那筆錢留下來了，它後來變成別的東西。', bad: '車貸、保養、停車位。它每個月都在提醒你。' },
      { id: 'normal', label: '買台二手的', odds: '0', mag: 2, good: '你把那筆錢留下來了，它後來變成別的東西。', bad: '車貸、保養、停車位。它每個月都在提醒你。' },
      { id: 'bold', label: '買想要的那台', odds: '-25', mag: 3, good: '你把那筆錢留下來了，它後來變成別的東西。', bad: '車貸、保養、停車位。它每個月都在提醒你。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '只保醫療險', odds: '+30', mag: 2, good: '很多年後真的用到了，那天你想起簽名的那個下午。', bad: '繳了十年才發現，那個報酬率連定存都不如。' },
      { id: 'normal', label: '買個儲蓄型', odds: '-5', mag: 2, good: '很多年後真的用到了，那天你想起簽名的那個下午。', bad: '繳了十年才發現，那個報酬率連定存都不如。' },
      { id: 'bold', label: '買一整套', odds: '-25', mag: 3, good: '很多年後真的用到了，那天你想起簽名的那個下午。', bad: '繳了十年才發現，那個報酬率連定存都不如。' },
    ],
    good: {
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '量力而為', odds: '+20', mag: 1, good: '他們沒說什麼，但你知道他們跟鄰居講過這件事。', bad: '你的存款曲線在那幾年是平的。' },
      { id: 'normal', label: '每月固定給', odds: '0', mag: 2, good: '他們沒說什麼，但你知道他們跟鄰居講過這件事。', bad: '你的存款曲線在那幾年是平的。' },
      { id: 'bold', label: '全部我來', odds: '-20', mag: 3, good: '他們沒說什麼，但你知道他們跟鄰居講過這件事。', bad: '你的存款曲線在那幾年是平的。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '照實申報', odds: '+30', mag: 1, good: '合法的範圍內，你少繳了一些。', bad: '補稅通知單上的金額，比你省下來的多一個零。' },
      { id: 'normal', label: '找會計師看看', odds: '+5', mag: 2, good: '合法的範圍內，你少繳了一些。', bad: '補稅通知單上的金額，比你省下來的多一個零。' },
      { id: 'bold', label: '能省的都省', odds: '-30', mag: 3, good: '合法的範圍內，你少繳了一些。', bad: '補稅通知單上的金額，比你省下來的多一個零。' },
    ],
    good: {
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '公證就好', odds: '+30', mag: 2, good: '禮金剛好打平，而且那天真的很好。', bad: '為了那一天的排場，你們吵了三個月。' },
      { id: 'normal', label: '辦個小的', odds: '0', mag: 2, good: '禮金剛好打平，而且那天真的很好。', bad: '為了那一天的排場，你們吵了三個月。' },
      { id: 'bold', label: '風風光光辦一場', odds: '-25', mag: 3, good: '禮金剛好打平，而且那天真的很好。', bad: '為了那一天的排場，你們吵了三個月。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '不買', odds: '+40', mag: 1, good: '中了小獎。那種心情比獎金貴。', bad: '一整年的號碼，一次都沒對過。' },
      { id: 'normal', label: '買一張', odds: '0', mag: 2, good: '中了小獎。那種心情比獎金貴。', bad: '一整年的號碼，一次都沒對過。' },
      { id: 'bold', label: '每期都買', odds: '-40', mag: 3, good: '中了小獎。那種心情比獎金貴。', bad: '一整年的號碼，一次都沒對過。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '存起來不動', odds: '+30', mag: 2, good: '這筆錢來得突然，也來得剛好——你這輩子第一次，本金追上了眼光。', bad: '錢還沒到手就分完了，親戚之間多了幾條裂縫。' },
      { id: 'normal', label: '一部分拿去投資', odds: '0', mag: 2, good: '這筆錢來得突然，也來得剛好——你這輩子第一次，本金追上了眼光。', bad: '錢還沒到手就分完了，親戚之間多了幾條裂縫。' },
      { id: 'bold', label: '全部投進去', odds: '-25', mag: 4, good: '這筆錢來得突然，也來得剛好——你這輩子第一次，本金追上了眼光。', bad: '錢還沒到手就分完了，親戚之間多了幾條裂縫。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '存進定存', odds: '+30', mag: 2, good: '那筆資遣費在你手上變成了別的東西。', bad: '錢在找到下一份工作之前就用完了。' },
      { id: 'normal', label: '撐到找到下一份', odds: '0', mag: 2, good: '那筆資遣費在你手上變成了別的東西。', bad: '錢在找到下一份工作之前就用完了。' },
      { id: 'bold', label: '拿去創業', odds: '-30', mag: 4, good: '那筆資遣費在你手上變成了別的東西。', bad: '錢在找到下一份工作之前就用完了。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '優先還債', odds: '+30', mag: 2, good: '數字終於開始往下走了。', bad: '利息像水位一樣，你游得再快也只是原地。' },
      { id: 'normal', label: '一邊還一邊投資', odds: '0', mag: 2, good: '數字終於開始往下走了。', bad: '利息像水位一樣，你游得再快也只是原地。' },
      { id: 'bold', label: '借新還舊拚翻身', odds: '-35', mag: 3, good: '數字終於開始往下走了。', bad: '利息像水位一樣，你游得再快也只是原地。' },
    ],
    good: {
      effects: [
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '公立就好', odds: '+25', mag: 2, good: '孩子長成了他自己的樣子，跟錢沒什麼關係。', bad: '教育帳單是唯一一種你不敢殺價的帳單。' },
      { id: 'normal', label: '補習補一點', odds: '0', mag: 2, good: '孩子長成了他自己的樣子，跟錢沒什麼關係。', bad: '教育帳單是唯一一種你不敢殺價的帳單。' },
      { id: 'bold', label: '全部都給最好的', odds: '-25', mag: 3, good: '孩子長成了他自己的樣子，跟錢沒什麼關係。', bad: '教育帳單是唯一一種你不敢殺價的帳單。' },
    ],
    good: {
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '早點就醫', odds: '+25', mag: 2, good: '檢查出來沒什麼大事，醫生要你少喝一點。', bad: '住院那幾天，你第一次認真算了一下自己還剩多少年。' },
      { id: 'normal', label: '吃藥撐著', odds: '-5', mag: 2, good: '檢查出來沒什麼大事，醫生要你少喝一點。', bad: '住院那幾天，你第一次認真算了一下自己還剩多少年。' },
      { id: 'bold', label: '沒空，先工作', odds: '-30', mag: 3, good: '檢查出來沒什麼大事，醫生要你少喝一點。', bad: '住院那幾天，你第一次認真算了一下自己還剩多少年。' },
    ],
    good: {
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '正常過', odds: '+25', mag: 1, good: '你發現想要的東西比你以為的少很多。', bad: '省下來的錢，在年底的一個晚上全部花掉了。' },
      { id: 'normal', label: '砍掉一半娛樂', odds: '0', mag: 2, good: '你發現想要的東西比你以為的少很多。', bad: '省下來的錢，在年底的一個晚上全部花掉了。' },
      { id: 'bold', label: '一整年不買任何非必需品', odds: '-25', mag: 3, good: '你發現想要的東西比你以為的少很多。', bad: '省下來的錢，在年底的一個晚上全部花掉了。' },
    ],
    good: {
      effects: [
        { type: 'stat.add', key: 'savingsRate', value: 0.05 },
  ...
  },
  {
    ...
    choices: [
      { id: 'safe', label: '直接掛掉', odds: '+40', mag: 1, good: '你掛掉電話，回頭把家人的號碼也設成拒接。', bad: '匯出去的時候你完全相信自己在做對的事。' },
      { id: 'normal', label: '聽他講完', odds: '0', mag: 2, good: '你掛掉電話，回頭把家人的號碼也設成拒接。', bad: '匯出去的時候你完全相信自己在做對的事。' },
      { id: 'bold', label: '照他說的去操作', odds: '-45', mag: 3, good: '你掛掉電話，回頭把家人的號碼也設成拒接。', bad: '匯出去的時候你完全相信自己在做對的事。' },
    ],
    good: {
